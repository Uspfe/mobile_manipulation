...
from mmseq_plan.TaskManager import SoTStatic, SoTCycle
...
class ControllerROSNode:
    ...
    def __init__(self):
        ...
        self.sot = SoTCycle(planner_config)
        ...
        self.shuffle_srv = rospy.Service('shuffle', EmptySrv, self._shuffle_sot)
        rospy.on_shutdown(self.shutdownhook)
        self.ctrl_c = False
        self.run()

    def _shuffle_sot(self, req):
        self.sot.shuffle()
...
if __name__ == "__main__":
    rospy.init_node("controller_ros_simple_demo")
