...
def main():
    ...
    X0_array, tf = initial_guess_simple(
        mobile_robot, points_full, starting_configuration, prediction_horizon, N
    )
    ...
    start_time = time.time()
    X_seq, total_elements_sequential, _ = sequential_plan.optimize_sequential(
    ...
    compare_trajectories_casadi_plot(
        ...
        forward_kinematic,
        q_size=qs_num,
        state_dim=[total_elements, total_elements_sequential],
        labels=["CPC", "Sequential"],
        obstacles=[],
    )
